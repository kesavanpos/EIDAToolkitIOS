...
def getCLIArgEnvName (argName)
  return "CLI_ARG_" + snakeUpperCase(argName) + "_7629b1f6107d43d3d2d9dcd640286b21";
end

def getEnvVar (envVarName)
  result = 
      ENV[snakeUpperCase(envVarName) + "_7629b1f6107d43d3d2d9dcd640286b21"] ||
...
def promoteBuildEnvVarForCurrentProcess (envVarName)
  ...
  buildLevelEnvValue = ENV[envVarName + "_7629b1f6107d43d3d2d9dcd640286b21"];
